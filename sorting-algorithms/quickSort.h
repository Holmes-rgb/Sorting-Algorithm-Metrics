...
template<typename Comparable>
vector<Comparable> quickSortUnstable(vector<Comparable> vec, int& reads, int& writes) {
...
template<typename Comparable>
vector<Comparable> quickSortStable(vector<Comparable> vec, int& reads, int& writes) {
